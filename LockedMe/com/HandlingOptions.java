...
import java.util.Scanner;
	...
	public class HandlingOptions {
		public static void handleWelcomeScreenInput() {
			...
			do {
				try {
					...
					switch (input) {
					case 1:
						OperationFiles.displayAllFiles("main");
						break;
					case 2:
		...
		public static void handleFileMenuOptions() {
			...
			do {
				try {
					OptionsforMenu.displayFileMenuOptions();
					...
					case 1:
						...
						OperationFiles.createFile(fileToAdd, sc);
					...
					case 2:
						...
						OperationFiles.createMainFolderIfNotPresent("main");
						List<String> filesToDelete = OperationFiles.displayFileLocations(fileToDelete, "main");
						...
						if (idx != 0) {
							OperationFiles.deleteFileRecursively(filesToDelete.get(idx - 1));
						} else {
							
							// If idx == 0, delete all files displayed for the name
							for (String path : filesToDelete) {
								OperationFiles.deleteFileRecursively(path);
							}
						}
					...
					case 3:
						...
						OperationFiles.createMainFolderIfNotPresent("main");
						OperationFiles.displayFileLocations(fileName, "main");
